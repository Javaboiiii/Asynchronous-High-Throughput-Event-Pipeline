...
const (
	SubmissionService_SubmitHandler_FullMethodName = "/submission.SubmissionService/SubmitHandler"
)
...
type SubmissionServiceClient interface {
	SubmitHandler(ctx context.Context, in *SubmissionRequest, opts ...grpc.CallOption) (*EvaluationResult, error)
}
...
func (c *submissionServiceClient) SubmitHandler(ctx context.Context, in *SubmissionRequest, opts ...grpc.CallOption) (*EvaluationResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EvaluationResult)
	err := c.cc.Invoke(ctx, SubmissionService_SubmitHandler_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SubmissionServiceServer interface {
	SubmitHandler(context.Context, *SubmissionRequest) (*EvaluationResult, error)
...
func (UnimplementedSubmissionServiceServer) SubmitHandler(context.Context, *SubmissionRequest) (*EvaluationResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitHandler not implemented")
}
...
func _SubmissionService_SubmitHandler_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmissionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubmissionServiceServer).SubmitHandler(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubmissionService_SubmitHandler_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubmissionServiceServer).SubmitHandler(ctx, req.(*SubmissionRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SubmissionService_SubmitHandler_Handler,
		},
	},
